...
@ConditionalOnExpression("'${core.aws.role-switching.enable:false}'.equals('false')")
@Configuration
public class AwsContainerCredentialConfig implements AwsConfigIf{


    @Value("${core.safenet.crypto-properties.dir:safenet/default/CryptoContexts.properties}")
    private String cryptoProperties;
    @Value("${core.safenet.IngrianNAE-properties.dir:safenet/dafault/IngrianNAE.properties}")
