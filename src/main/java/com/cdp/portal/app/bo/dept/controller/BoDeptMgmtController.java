package com.cdp.portal.app.bo.dept.controller;
...
import com.cdp.portal.app.facade.dept.dto.response.DeptMgmtResDto.ApiResDepts;
...
@RequestMapping(value = CommonConstants.API_BO_PREFIX + "/dept-mgmt")
@Tag(name = "dept-mgmt", description = "부서 관리 API")
public class BoDeptMgmtController {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "OK", content = @Content(schema = @Schema(implementation = ApiResDepts.class)))
        }
    )
