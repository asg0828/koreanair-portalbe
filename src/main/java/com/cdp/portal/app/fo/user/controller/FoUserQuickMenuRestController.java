...
import com.cdp.portal.app.facade.user.service.UserQuickMenuUserService;
...
public class FoUserQuickMenuRestController {

    private final UserQuickMenuUserService userQuickMenuUserService;
    ...
    public ResponseEntity<?> createUserQuickMenu(@PathVariable String userId, @Valid @RequestBody UserQuickMenuReqDto.CreateQuickMenu dto) {
    	userQuickMenuUserService.createUserQuickMenu(userId, dto);
    ...
    public ResponseEntity<?> deleteUserQuickMenu(@PathVariable String userId, @PathVariable String menuId) {
    	userQuickMenuUserService.deleteUserQuickMenu(userId, menuId);
    ...
    public ResponseEntity<?> getUserQuickMenu(
        ...
        return ResponseEntity.ok(ApiResDto.success(userQuickMenuUserService.getUserQuickMenus(userId)));
    }
